...
<script>
    ...
    var shows_http_source = (site_base && site_base !== '')
        ...
        : './images/fav_shows/';
    var favorite_shows = [
        {"img": "(https://github.com/user-attachments/assets/061d9df9-62c1-489d-9776-95413086d1a4)", "title": "Frieren Beyond Journey's End"},
        {"img": "(https://github.com/user-attachments/assets/58f2e77d-baa2-4bbb-a0d2-c62e96afb659)", "title": "Solo Leveling"},
        {"img": "(https://github.com/user-attachments/assets/2134cdf4-4c4d-4dfc-9502-4846a98ce9a1)", "title": "Jujutsu Kaisen"},
    ];
